...
python FormatSeq2Seq_qrecc.py $SCRATCH/canard/data/qrecc/release/qrecc_train.json train $SCRATCH/canard/data/qrecc --spacy True --make_dev_from_train --dev_percent 10
python FormatSeq2Seq_qrecc.py $SCRATCH/canard/data/qrecc/release/qrecc_test.json test $SCRATCH/canard/data/qrecc --spacy True
...
do
    python translate.py -gpu 0 \
                        -batch_size 20 \
                        -beam_size 10 \
                        -model "$MODEL_PATH"_step_380000.pt \
